...
public class HttpClient {
    ...
    private class Login extends HttpTrans {
        ...
        @Override
        public boolean resultProcess(JSONObject result) {
            /**
             *
            ...
            try {
                ...
                if (result.getBoolean("status")) {
                    ...
                    Intent intent = new Intent(actControl, ButtonList.class);
                    intent.addFlags(intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.addFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                    actControl.startActivity(intent);
        ...
        public boolean resultProcess(JSONObject result) {
            ...
            try {
                ...
                if (result.getBoolean("status")) {
                    ...
                    toast = Toast.makeText(actControl.getApplicationContext(), "회원가입 실패 : " + result.getString("message"), Toast.LENGTH_LONG);
                    toast.show();
